...
ggplot(data_long, aes(x = Variable, y = Score)) +
  ...
  labs(title = "Box Plot of Happiness Scores by Variable", x = "Variables Affecting Happiness Score", y = "Happiness Score")
```


* Distribution of the values:
Corruption variable is narrowly distributed, mostly concentrated near the lower score values, showing a low happiness score in relation to perceived corruption.
...
Corruption shows a very tight IQR, close to the lower score limits. Economy, Freedom, and Health have moderately sized IQRs. Social has the largest IQR, suggesting significant variability in how social factors affect happiness.
...
ggplot(data_long, aes(x = Variable, y = Score, fill = Variable)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "Violin Plot of Happiness Scores by Variable", x = "Variables Affecting Happiness Score", y = "Happiness Score") +
...
data %>%
  ...
  labs(title = "HeatMap between Variables and Happiness Score", x= "Variables Affecting Happiness Score", y= "Happiness Score") +
